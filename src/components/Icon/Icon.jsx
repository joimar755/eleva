...
const Icon = () => {
  return (
    ...
    <div className="absolute top-full right-4 md:right-[100px] shadow-white  transform -translate-y-1/2 bg-slate-600 p-5 rounded-3xl opacity-95 py-8  -mt-[200px] flex flex-col items-center gap-6">
